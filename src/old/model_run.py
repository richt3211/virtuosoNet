...
parser.add_argument("-model_name", "--model_name", default='Default Model Name', type=str, help="The Model Name description to print in the logs")
...
with open(f'{args.dataName}_stat.pickle', "rb") as f:
...
if args.sessMode == 'train':
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        mean_deviation_loss = np.mean(dev_loss_total)
